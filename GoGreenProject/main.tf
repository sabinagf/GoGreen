...
resource "aws_instance" "instance_az2" {
  ...
  resource "aws_instance" "pr_instanceaz1" {
  ami = "ami-0d9b5e9b3272cff13"
  instance_type = "t3.micro"
  subnet_id = aws_subnet.private_app_subnet_az1.id
  availability_zone = aws_subnet.private_app_subnet_az1.availability_zone
...
resource "aws_instance" "pr_instanceaz2" {
  ami = "ami-0d9b5e9b3272cff13"
  instance_type = "t2.micro"
  subnet_id = aws_subnet.private_app_subnet_az2.id
  availability_zone = aws_subnet.private_app_subnet_az2.availability_zone
...
resource "aws_lb" "example" {
  ...
  subnets = [
    aws_subnet.public_subnet_az1.id,  # Replace with your private subnet 1 ID
    aws_subnet.public_subnet_az2.id,
    # aws_subnet.private_app_subnet_az1.id,
    # aws_subnet.private_app_subnet_az2.id,
    # aws_subnet.private_data_subnet_az1.id,
